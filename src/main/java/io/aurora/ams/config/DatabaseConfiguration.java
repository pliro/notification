...
import io.aurora.ams.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories("io.aurora.ams.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("io.aurora.ams.repository.search")
