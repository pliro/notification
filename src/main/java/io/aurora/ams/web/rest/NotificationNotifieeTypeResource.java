...
public class NotificationNotifieeTypeResource {
    ...
    @RequestMapping(value = "/notification-notifiee-types",
        ...
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public List<NotificationNotifieeType> getAllNotificationNotifieeTypes() {
        log.debug("REST request to get all NotificationNotifieeTypes");
        List<NotificationNotifieeType> notificationNotifieeTypes = notificationNotifieeTypeRepository.findAll();
        return notificationNotifieeTypes;
    }
    ...
    @RequestMapping(value = "/_search/notification-notifiee-types",
        ...
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public List<NotificationNotifieeType> searchNotificationNotifieeTypes(@RequestParam String query) {
        log.debug("REST request to search NotificationNotifieeTypes for query {}", query);
        return StreamSupport
            .stream(notificationNotifieeTypeSearchRepository.search(queryStringQuery(query)).spliterator(), false)
