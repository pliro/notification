...
public class NotificationTemplateResource {
    ...
    @RequestMapping(value = "/notification-templates",
        ...
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<List<NotificationTemplate>> getAllNotificationTemplates(Pageable pageable)
        throws URISyntaxException {
        log.debug("REST request to get a page of NotificationTemplates");
        Page<NotificationTemplate> page = notificationTemplateRepository.findAll(pageable); 
    ...
    @RequestMapping(value = "/_search/notification-templates",
        ...
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<List<NotificationTemplate>> searchNotificationTemplates(@RequestParam String query, Pageable pageable)
        throws URISyntaxException {
        log.debug("REST request to search for a page of NotificationTemplates for query {}", query);
        Page<NotificationTemplate> page = notificationTemplateSearchRepository.search(queryStringQuery(query), pageable);
