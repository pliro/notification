(function() {
    ...
    NotificationChannelDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', 'entity', 'NotificationChannel', 'NotificationTemplate'];

    function NotificationChannelDialogController ($timeout, $scope, $stateParams, $uibModalInstance, entity, NotificationChannel, NotificationTemplate) {
        var vm = this;
