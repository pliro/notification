(function() {
    ...
    NotificationNotifieeTypeDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', 'entity', 'NotificationNotifieeType', 'NotificationTemplate'];

    function NotificationNotifieeTypeDialogController ($timeout, $scope, $stateParams, $uibModalInstance, entity, NotificationNotifieeType, NotificationTemplate) {
        var vm = this;
